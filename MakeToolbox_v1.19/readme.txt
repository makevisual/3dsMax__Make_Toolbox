...
Put MAKE_Toolbox_startup.ms in your startup directory to have it launch at startup, this will respect the user settings of launch at startup

---- MakeToolbox_v1.17.2 ----
-- Date: 2015-09-03
-- Modifications by: Aaron Dabelow theonlyaaron@gmail.com
-- Change Log:
	* Added option to have MT_Autobak startup automatically when the toolbox opens
